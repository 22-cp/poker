...
void desk::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->overChanged(); break;
        case 7: _t->onNowPlayChanged(); break;
        case 8: _t->onNumChanged(); break;
        case 9: _t->onLandlordChanged(); break;
        case 10: _t->onAlreadyChanged(); break;
        case 11: _t->onTemLandlordChanged(); break;
        case 12: _t->onMarkChanged(); break;
        case 13: _t->onOverChanged(); break;
        case 14: { int _r = _t->getNumRef();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 15: _t->dealCard(); break;
        case 16: { std::vector<people::poker> _r = _t->getP1Hand();
            if (_a[0]) *reinterpret_cast< std::vector<people::poker>*>(_a[0]) = std::move(_r); }  break;
        case 17: { std::vector<people::poker> _r = _t->getP2Hand();
            if (_a[0]) *reinterpret_cast< std::vector<people::poker>*>(_a[0]) = std::move(_r); }  break;
        case 18: { std::vector<people::poker> _r = _t->getP3Hand();
            if (_a[0]) *reinterpret_cast< std::vector<people::poker>*>(_a[0]) = std::move(_r); }  break;
        ...
        {
            using _t = void (desk::*)();
            if (_t _q_method = &desk::overChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
        ...
        case 6: *reinterpret_cast< int*>(_v) = _t->getOver(); break;
        default: break;
        }
        ...
        case 6: _t->setOver(*reinterpret_cast< int*>(_v)); break;
        default: break;
        }
