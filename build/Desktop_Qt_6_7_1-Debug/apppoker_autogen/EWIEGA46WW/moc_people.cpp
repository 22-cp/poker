...
Q_CONSTINIT static const uint qt_meta_data_CLASSpeopleENDCLASS[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       1,    0,   92,    2, 0x06,    2 /* Public */,

 // slots: name, argc, parameters, tag, flags, initial metatype offsets
       3,    0,   93,    2, 0x0a,    3 /* Public */,

 // methods: name, argc, parameters, tag, flags, initial metatype offsets
       4,    0,   94,    2, 0x02,    4 /* Public */,
       5,    0,   95,    2, 0x02,    5 /* Public */,
       6,    1,   96,    2, 0x02,    6 /* Public */,
       9,    1,   99,    2, 0x02,    8 /* Public */,
      11,    1,  102,    2, 0x02,   10 /* Public */,
      14,    1,  105,    2, 0x02,   12 /* Public */,
      15,    1,  108,    2, 0x02,   14 /* Public */,
      16,    0,  111,    2, 0x02,   16 /* Public */,
      17,    0,  112,    2, 0x02,   17 /* Public */,
      18,    1,  113,    2, 0x02,   18 /* Public */,
      19,    1,  116,    2, 0x02,   20 /* Public */,
...
void people::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 8: { int _r = _t->getCardNumber((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 9: { int _r = _t->getHandSize();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 10: { std::vector<int> _r = _t->getNum1();
            if (_a[0]) *reinterpret_cast< std::vector<int>*>(_a[0]) = std::move(_r); }  break;
        case 11: { bool _r = _t->pushCard((*reinterpret_cast< std::add_pointer_t<std::vector<int>>>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 12: _t->toushCard((*reinterpret_cast< std::add_pointer_t<std::vector<poker>>>(_a[1]))); break;
        default: ;
        }
